...
+ Metropolitan areas (`Marea`s) are defined as groups of Azones that define them
...
+ Economy
    ...
    + Annual household ownership costs (depreciation, vehicle maintenance, tires, finance charge, insurance, registration)
...
+ Energy
    ...
    + Average fuel efficiency (net miles per gallon) for all vehicles
